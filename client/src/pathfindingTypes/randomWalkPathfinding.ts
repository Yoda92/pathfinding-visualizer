...
export class RandomWalkPathfinding implements PathfindingAlgorithmType {
  public async accept(
    ...
    return visitor.runRandomWalkPathfindingAlgorithm(grid, sleepToken, cancellationToken);
  }
}
